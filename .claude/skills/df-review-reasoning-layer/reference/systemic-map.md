...
uniform across Analyst/Explorer/Advisor via `agents/toolsets.py::merge_app_tools`, and toggle heads must
receive the SAME app_tools for capability continuity); the nexus pin
