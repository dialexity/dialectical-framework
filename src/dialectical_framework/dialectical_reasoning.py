...
class DialecticalReasoning(containers.DeclarativeContainer):
    ...
    brain = providers.Singleton(lambda: DialecticalReasoning._setup_brain())

    config = providers.Singleton(lambda: DialecticalReasoning._setup_config())
    ...
    wheel_builder = providers.Factory(WheelBuilder)
