...
class SymmetricalTransition(TransitionSegmentToSegment):
    ...
    opposite_source_aliases: list[str] = Field(default_factory=list, description="Aliases of the source segment of the wheel.")
    opposite_target_aliases: list[str] = Field(default_factory=list, description="Aliases of the target segment of the wheel.")
