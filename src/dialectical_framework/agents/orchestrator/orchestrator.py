...
- **Perspective**: A dialectical tension pairing thesis (T) with antithesis (A), plus their angles (T+, T-, A+, A-).
...
- **POSITIVE_SIDE_OF**: Angle → neutral (T+ → T)
- **NEGATIVE_SIDE_OF**: Angle → neutral (T- → T)
