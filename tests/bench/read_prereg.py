"""Read one saved stem in the PRE-REGISTERED order: gates first, delta second.
    ...
    poetry run python tests/bench/read_prereg.py <stem> [hi_arm] [lo_arm]
    poetry run python tests/bench/read_prereg.py r21-strong-current-build A2 A1.7
...
from tests.bench.report import (  # noqa: E402
    collect_deltas,
    drop_invalid,
    invalid_cells,
    load_records,
