"""Does the round-by-round loop converge? Free, over every saved judged run.
    ...
    poetry run python tests/e2e/round_trend.py
...
def series(
    *,
    ...
    """
    from e2e.across_runs import tier_model  # local: avoids an import cycle
...
def _canonical_model(tier: str) -> str | None:
    ...
    from e2e.across_runs import pooled_model
