"""Can the five r17 prompt fixes be seen by a machine, and what is the baseline?
    ...
    poetry run python tests/e2e/probe_five_fixes.py
...
from e2e.across_runs import (cross_model_stems, pooled_model,  # noqa: E402
                               tier_model)
from e2e.models import RunRecord, SessionRecord  # noqa: E402
from e2e.report import load_records  # noqa: E402
from e2e.scoring import _RECORD_REQUEST, score_menu  # noqa: E402
