"""Re-render a saved run's report with the CURRENT report code.
    ...
    poetry run python tests/e2e/rerender.py claim2-weak-r16-floor
    poetry run python tests/e2e/rerender.py --all --write
...
scoring change needs `DIALEXITY_E2E_REJUDGE`, which costs money.
...
from e2e.models import Comparison, MachineScores, RunRecord  # noqa: E402
from e2e.report import load_records, render_report  # noqa: E402
