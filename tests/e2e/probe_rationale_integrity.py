"""Does a recorded rationale assert the objection it survived is VOID?
    ...
    poetry run python tests/e2e/probe_rationale_integrity.py
    poetry run python tests/e2e/probe_rationale_integrity.py --show
    poetry run python tests/e2e/probe_rationale_integrity.py --forensics
