...
def render_report(
    ...
    add("   READ 2026-08-19 (r23-controls, n=12 strong): NEITHER TRIPWIRE FIRES.")
    add("   poorfit_ssl_expiry +0.333 [-0.016,+0.683] passes by 0.016 — the same")
    add("   magnitude as the live +0.325 claim, on 3 dimensions instead of 12.")
    ...
    add("   Quote the verdict with both qualifications or not at all, and do")
    add("   not read a run that omits the controls as having passed a control")
    add("   it never took.")
    return "\n".join(lines)
